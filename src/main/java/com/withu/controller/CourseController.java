...
public class CourseController {
     ...
     */
    @PutMapping("/update")
    public Result<String> updateCourse(@org.springframework.web.bind.annotation.RequestBody CourseUpdateDTO courseUpdateDTO) {
        boolean ok = courseService.updateCourse(courseUpdateDTO);
